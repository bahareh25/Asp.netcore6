...
internal static class HostingExtensions
{
    ...
    {
        string cnn = "Server=.;Initial catalog=IdServerDb; User Id=sa;Password=123;Encrypt=false";
        ...
        builder.Services.AddIdentityServer(options =>
            ...
            .AddConfigurationStore(c => {
                ...
                {
                    sql.MigrationsAssembly(assembly).MigrationsHistoryTable("ConfMigrationTable", "Config");
                });
            })
